...
class Myprefix_Admin {
	...
	private function __construct() {
		// Set our title
		$this->title = __( 'Opzioni Sito', 'myprefix' );
	}
	...
	function add_options_page_metabox() {
    	...
    	$cmb->add_field( array(
	    	'name' => 'Manchette',
	    	'desc' => 'Flaggare per disabilitare la manchette',
	    ...
	    $cmb->add_field( array(
	    	'name' => 'Banner',
	    	'desc' => 'Flaggare per disabilitare il banner',
	    	'id'   => 'banner_checkbox',
	    	'type' => 'checkbox',
	    	) );
	
    	$cmb->add_field( array(
			'name' => __( 'Orario', 'myprefix' ),
			'desc' => __( 'Orario visualizzato in alto nel sito', 'myprefix' ),
			'id'   => 'testbanner',
			'type' => 'textarea_small',
			'default' => '',
		) );
